...
func (x *Bestiary) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *Bestiary) GetPublic() bool {
	if x != nil {
		return x.Public
	}
	return false
...
func (x *Bestiary) GetUserLogin() string {
	if x != nil {
		return x.UserLogin
	}
	return ""
...
func (x *Bestiary) GetLastUpdate() string {
	if x != nil {
		return x.LastUpdate
	}
	return ""
...
type BGResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Bestiary      *Bestiary              `protobuf:"bytes,1,opt,name=bestiary,proto3" json:"bestiary,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BGResponse) GetBestiary() *Bestiary {
	if x != nil {
		return x.Bestiary
	}
	return nil
...
const file_Bestiary_Bestiary_proto_rawDesc = "" +
	...
	"\rEmptyResponse\"\xbd\x01\n" +
	"\bBestiary\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x03R\x06userId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x16\n" +
	"\x06public\x18\x04 \x01(\bR\x06public\x12\x1d\n" +
	"\n" +
	"user_login\x18\x05 \x01(\tR\tuserLogin\x12\x1f\n" +
	"\vlast_update\x18\x06 \x01(\tR\n" +
	"lastUpdate\x12\x1c\n" +
	"\tdownloads\x18\a \x01(\x05R\tdownloads\"p\n" +
	...
	"\n" +
	"BGResponse\x12.\n" +
	"\bbestiary\x18\x01 \x01(\v2\x12.Bestiary.BestiaryR\bbestiary2\xcd\x05\n" +
...
var file_Bestiary_Bestiary_proto_depIdxs = []int32{
	...
	2,  // 7: Bestiary.BGResponse.bestiary:type_name -> Bestiary.Bestiary
